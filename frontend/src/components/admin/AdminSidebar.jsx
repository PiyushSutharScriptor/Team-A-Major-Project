...
const AdminSidebar = ({ isOpen, onClose }) => {
  ...
  const links = [
    ...
    { name: 'All Issues', path: '/admin/issues', icon: '📋' },
    { name: 'Map View', path: '/admin/map', icon: '🗺️' },
    { name: 'Resources', path: '/admin/resources', icon: '👷' },
    { name: 'Admin Management', path: '/admin/management', icon: '👥' },
    { name: 'Add Admin', path: '/admin/add-admin', icon: '🛡️' },
  ...
  const sidebarContent = (
    <aside className="w-64 bg-dark-800 border-r border-dark-700 flex flex-col h-full">
      <div className="h-16 flex items-center px-4 border-b border-dark-700 justify-between">
        <img src="/logo.png" alt="Command Center" className="max-h-14 w-full object-contain" />
      ...
      <div className="flex-1 py-6 px-4 space-y-1 overflow-y-auto">
        <p className="px-4 text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Admin Menu</p>
